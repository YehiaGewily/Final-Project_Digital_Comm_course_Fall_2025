%% OFDM Project - Phase 5A: SISO AWGN (64-QAM)
% 1 Tx -> 1 Rx antenna
% Channel: AWGN only (no fading)
% Coding: Hamming (7,4)
% Expected Result: Waterfall BER curve for Coded 64-QAM in AWGN.
...
%% Plot Results
figure;
semilogy(EbNo_dB, BER, 'k-s', 'LineWidth', 2, 'MarkerFaceColor', 'k');
grid on;
title('SISO AWGN (64-QAM) with (7,4) Coding');
xlabel('Eb/N0 (dB)');
ylabel('Bit Error Rate (BER)');
legend('SISO AWGN 64-QAM');
ylim([1e-5 1]);
