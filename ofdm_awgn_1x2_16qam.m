%% OFDM Project - Phase 5A: SIMO 1x2 AWGN (16-QAM)
% 1 Tx -> 2 Rx antennas
...
%% Plot Results
figure;
semilogy(EbNo_dB, BER, 'm-d', 'LineWidth', 2, 'MarkerFaceColor', 'm');
grid on;
title('SIMO 1x2 AWGN (16-QAM) with (7,4) Coding');
xlabel('Eb/N0 (dB)');
ylabel('Bit Error Rate (BER)');
legend('SIMO 1x2 AWGN 16-QAM');
ylim([1e-5 1]);
